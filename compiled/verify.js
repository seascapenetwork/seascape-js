 ...
 */
exports["default"] = (function (params, signature, walletAddress) { return __awaiter(void 0, void 0, void 0, function () {
    var hash, message, arr, address, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                message = ethers_1.ethers.utils.solidityKeccak256(['string', 'bytes32'], ['\x19Ethereum Signed Message:\n32', hash]);
                arr = ethers_1.ethers.utils.arrayify(message);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ethers_1.ethers.utils.recoverAddress(arr, signature)];
            case 2:
                address = _a.sent();
                return [2 /*return*/, address.toLowerCase() == walletAddress.toLowerCase()];
            case 3:
                error_1 = _a.sent();
