...
var Provider = /** @class */ (function () {
    function Provider(remoteHttp) {
        this.internalProvider = new ethers_1.ethers.providers.JsonRpcProvider(remoteHttp);
    }
    Provider.prototype.internal = function () {
     ...
     */
    Provider.prototype.getBlockTimestamp = function (blockNumber) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.internalProvider.getBlock(blockNumber)];
                    case 1:
                        block = _a.sent();
